...
const NavBar = () => {
    const categorias = [{ content: 'Inicio', link: '/', customClass: '' }, { content: 'Productos', link: '/products', customClass: '' }, { content: 'Publicar', link: '/post', customClass: '' }, { content: 'Perfil', link: '/profile', customClass: '' }]
    return (
